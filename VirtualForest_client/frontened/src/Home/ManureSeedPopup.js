...
import compostBtn from "../Images/Compost button.png"
import icon1 from "../Images/image 1.svg"
import upIcon from "../Images/up.png"
import downIcon from "../Images/down.png"

export default function ManureSeedPopup({ open, setOpen }) {
    ...
    return (
        <div>
            <Dialog open={open} onClose={() => setOpen(false)} style={{ zIndex: "10001", fontFamily: "Inter" }}>
                <div className='py-2 px-2' style={{ background: "#3D4917" }}>
                    <div className='popupCrossBtn flex justify-center items-center' onClick={() => setOpen(false)} style={{ width: "20px", height: "20px", borderRadius: "100%", background: "#F67777", cursor: "pointer" }}>
                ...
                <div className='bg-white text-[#3D4917] flex flex-col justify-center px-5'>
                    <div className='text-center fs-4 my-1'>Manure</div>
                    <div className='flex justify-center mb-1'>
                        <img src={compostBtn} alt="compostBtn" className='w-[80px]' />
                    </div>
                    <div className='text-center mb-3 mt-1' style={{ fontWeight: "540" }}> Speeds up the Growth by 1 day! </div>
                    <div className='text-center flex gap-3'>
                        <div>No. of Manure Bags</div>
